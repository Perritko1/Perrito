<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" fill="none" :width="widthAttr" :height="heightAttr" overflow="visible">
    <g>
  ...
  export default {
    ...
    computed: {
      widthAttr() {
        ...
        return this.width || "26px";
      },

      heightAttr() {
        if (this.width) return undefined;
        if (this.size) return this.size;
        return this.height || "26px";
      }
    }
  }
</script>
